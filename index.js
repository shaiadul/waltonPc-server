...
const uri = `mongodb+srv://${[process.env.USER_NAME]}:${process.env.USER_PASS}@walton-pc.ppiop.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  ...
  try {
    ...
    // home server title 
    app.get('/', (req, res) => {
      res.send('Walton PC tools Manufacture Server is Running Successfully.')
    })
